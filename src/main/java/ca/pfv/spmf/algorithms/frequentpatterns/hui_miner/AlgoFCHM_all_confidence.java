...
//					int remain = remainingUtility; // FOR OPTIMIZATION
    ...
    private void fchm(int[] prefix,
                      int prefixLength, UtilityListFCHM_all_confidence pUL, List<UtilityListFCHM_all_confidence> ULs, int minUtility,
                      double minAll_confidence)
            throws IOException {
     ...
     */
    private UtilityListFCHM_all_confidence construct(UtilityListFCHM_all_confidence P, UtilityListFCHM_all_confidence px,
                                                     UtilityListFCHM_all_confidence py, int minUtility) {
