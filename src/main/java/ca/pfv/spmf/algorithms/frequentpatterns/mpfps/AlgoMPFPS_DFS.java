...
public class AlgoMPFPS_DFS {
     ...
     */
    public void runAlgorithm(double maxStandardDeviation, double minRA, int maxPeriodicity, int minimumSupport, String inputFile, String outputFile)
            throws Exception {
