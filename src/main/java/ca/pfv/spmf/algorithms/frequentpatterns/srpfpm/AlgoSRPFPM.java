 ...
 * <br/><br/>
 * Nofong, V. M., Abdel-Fatao H., Afriyie, M. K. and Wondoh, J.: Discovering Self-Reliant Periodic Frequent Patterns. In: Kiran, R. U.,
 * Fournier-Viger, P., Mondal, A., Luna, J. M., and Lin, J. CW. (eds), Periodic Pattern Mining: Theory, Algorithms and Applications, pp. 105–131,
 * 2021..
 * <p>
 * <br/><br/>
 * <p>
...
public class AlgoSRPFPM {
     ...
     */
    public Itemsets runAlgorithm(String input, String output, double minsupp, double minAverage, double maxAverage, double minPeriod,
                                 double maxPeriod)
            throws IOException {
        // record start time
...
//                         buffer.append(periodList);
            ...
            } else if (itemForSubset.size() < 2 && support != transactionCount) {  //if support == transactionCount, and its length-1, it is not
                // productive
                 /*
