 ...
 * "Nader Aryabarzan, Behrouz Minaei-Bidgoli, and Mohammad Teshnehlab. (2018). negFIN: An efficient algorithm for fast mining frequent itemsets.
 ...
 * <p>
 * Both the C++/Java code of the negFIN algorithms are respectively based on the C++/Java code of the "FIN algorithm", the algorithm which is
 * presented in:
