    ...
    public void printItemsets() {
        ...
        for (List<Itemset> level : levels) {
            ...
            for (Itemset itemset : level) {
                ...
                // print the itemset
                System.out.print("  pattern " + patternCount + ":  " + itemset);
//				itemset.print();
    ...
    /* (non-Javadoc)
     * @see ca.pfv.spmf.patterns.itemset_array_integers_with_count.AbstractItemsets#addItemset(ca.pfv.spmf.patterns
     * .itemset_array_integers_with_count.Itemset, int)
     */
