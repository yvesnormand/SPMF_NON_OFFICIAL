 ...
 * The C++ code of this algorithm was provided by Nader Aryabarzan, available on GitHub via https://github.com/aryabarzan/dFIN and https://github
 * .com/aryabarzan/negFIN/ respectively.
 * <p>
 * Both the C++/Java code of the dFIN algorithms are respectively based on the C++/Java code of the "FIN algorithm", the algorithm which is
 * presented in:
    ...
    void construct_PPC_tree(String filename) throws IOException {//XXX renamed to construct_PPC_tree
        ...
        while (((line = reader.readLine()) != null)) {
            ...
            for (int j = curPos; j < tLen; j++) {
                ...
                ppcNode.label = -transaction[j].num;
