...
public class HUIS {
     ...
     */
    private final List<Integer> bestItem = new ArrayList<Integer>();
    /**
     * The best item index list
     */
    private final List<Integer> bestItemIndex = new ArrayList<Integer>();
    /**
     * The best item spare list
     */
    private final List<Integer> bestItemSpare = new ArrayList<Integer>();
    /**
     * The best item spare index list
     */
    private final List<Integer> bestItemIndexSpare = new ArrayList<Integer>();
    /**
