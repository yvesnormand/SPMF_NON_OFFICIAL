...
public class AlgoHUIMSU {
     ...
     * new items
     */
    private final ArrayList<Integer> newitems = new ArrayList<Integer>();

    /**
     * item data
     */
    private final List<ArrayList<Integer>> itemsdata = new ArrayList<ArrayList<Integer>>();

    /**
     * fron items data
     */
    private final ArrayList<ArrayList<Integer>> frontitemsdata = new ArrayList<ArrayList<Integer>>();
