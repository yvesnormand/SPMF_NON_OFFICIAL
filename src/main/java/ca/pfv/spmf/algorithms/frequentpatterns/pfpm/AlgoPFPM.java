...
//		int compare = (int)( mapItemToItemInfo.get(item1).support - mapItemToItemInfo.get(item2).support);
        ...
        int compare = mapItemToItemInfo.get(item1).support - mapItemToItemInfo.get(item2).support;
     ...
     */
    public void runAlgorithm(String input, String output, int minPeriodicity, int maxPeriodicity, int minAveragePeriodicity,
                             int maxAveragePeriodicity)
            throws IOException {
        // reset maximum
