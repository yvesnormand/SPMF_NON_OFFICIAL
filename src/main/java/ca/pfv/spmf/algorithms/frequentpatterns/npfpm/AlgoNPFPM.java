 ...
 * <br/><br/>
 * Afriyie, M. K, Nofong, V. M., Wondoh, J., Abdel-Fatao, H. (2021, January) Efficient Mining of Non-Redundant Periodic Frequent Patterns. In
 * Vietnam Journal of Computer Science (Vol. 8, No. 4, pp 1-15). World Scientific Publishing Company.
 * Afriyie, M. K, Nofong, V. M., Wondoh, J., Abdel-Fatao, H. (2020, March) Mining Non-redundant Periodic Frequent Patterns.  In: Nguyen N.,
 * Jearanaitanakij K., Selamat A., Trawiński B., Chittayasothorn S. (eds) Intelligent Information and Database Systems. LNCS, Vol. 12033, pp
 * 321-331. Springer
 * <br/><br/>
 * <p>
...
public class AlgoNPFPM {
     ...
     */
    public Itemsets runAlgorithm(String input, String output, double minsupp, double periodicity, double difference)
            throws IOException {
        // record start time
    ...
    private void saveAllCombinationsOfPrefixPath(PFPNode[] fpNodeTempBuffer, int position,
        ...
        loop1:
        for (long i = 1, max = 1L << position; i < max; i++) {
