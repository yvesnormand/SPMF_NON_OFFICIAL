 ...
 * <p>
 * Siddharth Dawar, Vikram Goyal: UP-Hist Tree: An Efficient Data Structure for Mining High Utility Patterns from Transaction Databases. IDEAS
 * 2015: 56-61 <\br><\br>
 *
...
public class AlgoUPHist {
    ...
    static private final HashMap<Integer, ItemSummary> itemDetail = new HashMap<Integer, ItemSummary>();
...
//	/** the number of HUIs generated */
    ...
    private final List<Itemset> phuis = new ArrayList<Itemset>();
...
//					utility = utilityValues.get(i);
            ...
            uphistgrowth(tree, minUtility, new int[0], null);
...
//	}
    ...
    private int compareItemsDesc(int item1, int item2,
        ...
        int compare = mapItemEstimatedUtility.get(item2) - mapItemEstimatedUtility
                .get(item1);
        // if the same, use the lexical order otherwise use the TWU
        return (compare == 0) ? item1 - item2 : compare;
    }
    ...
    protected int[] realloc2(int[] oldItemSet, int newElement) {
        ...
        System.arraycopy(oldItemSet, 0, newItemSet, 1, oldItemSetLength);
...
//			long temp = System.currentTimeMillis();
    ...
    public int getHighUtilityValue(int itemName, int support, Hist histogram) {
        ...
        utility = Math.min(iDetail.totalUtility
                           - ((iDetail.support - support) * iDetail.minUtility),
                histogram.getMaxSupportInterU(support));
