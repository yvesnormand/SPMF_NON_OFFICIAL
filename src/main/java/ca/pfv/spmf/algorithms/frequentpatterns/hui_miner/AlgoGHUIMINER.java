...
//					return o2.support - o1.support;  // DECREASING SUPPORT ORDER
     ...
     */
    public void runAlgorithm(String input, String output, int minUtility, List<List<Itemset>> closedItemsets, Set<Integer> itemsInClosedItemsets)
            throws IOException {
            ...
            if (pX_UL.sumIutils + pX_UL.sumRutils >= minUtility) {
                ...
                for (int j = i + 1; j < extensionsULs.size(); j++) {
                    ...
                    UtilityListWithCriticalObjects
                            pXYUL = construct(pX_UL, pY_UL, minUtility);
