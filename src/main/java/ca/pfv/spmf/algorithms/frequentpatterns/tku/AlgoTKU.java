...
//		System.out.println(globalMinUtil);
    ...
    public FPtree BuildUPTree(int[] P1, String HDB) throws IOException // éإ߾é
    // //For
    // Global
    // Tree,
    // use
            ...
            for (int i = 0; i < flist2.size(); i++) {
                if (LP1[flist2.get(i)] >= globalMinUtil) {
                    ...
                    while (chlink != null) {
                        ...
                        path.remove(0); // remove the first item
