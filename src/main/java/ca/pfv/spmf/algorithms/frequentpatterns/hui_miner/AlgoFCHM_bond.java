...
public class AlgoFCHM_bond implements Serializable {
     ...
     **/
    private final boolean ENABLE_FHM_PRUNING = true;

    /**
     * bond pruning optimization
     **/
    private final boolean ENABLE_BOND_PAIR_PRUNING = true;
...
//						}
     ...
     */
    private UtilityListFCHM_bond construct(UtilityListFCHM_bond P, UtilityListFCHM_bond px, UtilityListFCHM_bond py, int minUtility,
                                           BitSetSupport bitsetPXY) {
		/*
