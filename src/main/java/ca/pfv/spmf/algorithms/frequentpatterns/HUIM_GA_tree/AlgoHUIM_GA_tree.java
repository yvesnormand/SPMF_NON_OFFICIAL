...
public class AlgoHUIM_GA_tree {
    ...
    public void runAlgorithm(String input, String output, int minUtility)
        ...
        //éééééééééдéééééԴéééééеģéȻéééééééдééééééééǴéééé
        //ééé뱾éééétwuPatternééééHTWU-1itemééééé²éééééûéдﵽéééĿéé
        ...
        twuPattern = new ArrayList<Integer>(mapItemToTWU.keySet());//ééééééééééݴélistéééбééé
        Collections.sort(twuPattern);//éééֵééééé
        ...
        if (maximalPatterns.size() == 0) {
            ...
            for (i = 0; i < maximalPatterns.size(); i++) {
                ...
                if (temp == pattern.size() || temp == tempPattern.size()) {
                    if (pattern.size() > tempPattern.size())// case1éépattern
                    // contains
                    // tempPattern
                    // eg:abcd & abc
                    {
            ...
            if (i == maximalPatterns.size())// case4éépattern and tempPattern
...
//			System.out.print(System.lineSeparator() + maximalPatterns.get(i) + ":");
    ...
    class ChroNode {
        ...
        double rfitness;//éééééӦééééééѡééȾɫééééнéééééé
