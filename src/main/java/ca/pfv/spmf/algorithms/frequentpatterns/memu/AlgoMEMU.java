 ...
 * <p>
 * Jerry Chun-Wei Lin, Shifeng Ren, and Philippe Fournier-Viger. MEMU: More Efficient Algorithm to Mine High Average-Utility Patterns with Multiple
 * Minimum Average-Utility Thresholds, IEEE Access (unpublished)
 *
 * @author Shi-Feng Ren
 * @see CAUList
 * @see CAUEntry
