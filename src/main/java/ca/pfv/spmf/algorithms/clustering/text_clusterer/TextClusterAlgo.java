...
public class TextClusterAlgo {
    private final HashSet<String> allWords = new HashSet<String>();
    private final HashMap<Integer, Integer> idMap = new HashMap<Integer, Integer>(); // map
    // between
// the
// recordId
// and
        ...
        try {
            ...
            if (inputPath != null && outputPath != null) {
                ...
                while (clusterIterator.hasNext()) {
                    TextCluster output = clusterIterator.next();
