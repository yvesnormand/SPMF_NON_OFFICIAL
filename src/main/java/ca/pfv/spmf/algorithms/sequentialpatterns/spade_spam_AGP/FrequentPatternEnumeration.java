...
public class FrequentPatternEnumeration {
     ...
     */
    private final double minSupportAbsolute;
    /**
     ...
     */
    public void execute(EquivalenceClass eq, boolean dfs, boolean keepPatterns, boolean verbose, Map<Integer, Map<Integer, Integer>> coocMapAfter,
        ...
        for (int i = eqMembers.size() - 1; i >= 0; i--) {
            ...
            for (int j = i; j >= 0; j--) {
                 ...
                 */
                List<Pattern> extensions = candidateGenerator.generateCandidates(child_X.getClassIdentifier(), child_Y.getClassIdentifier(),
                        (int) minSupportAbsolute, doNotExploreXY, doNotExploreYX, doNotExploreX_Y, doNotExploreY_X);
