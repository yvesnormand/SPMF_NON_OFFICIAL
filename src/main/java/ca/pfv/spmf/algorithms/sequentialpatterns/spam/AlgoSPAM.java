...
//						System.err.println("==" + token + "===");
     ...
     */
    private void dfsPruning(Prefix prefix, Bitmap prefixBitmap, List<Integer> sn, List<Integer> in, int hasToBeGreaterThanForIStep, int m)
            throws IOException {
...
//		System.out.println(r.toString());
    ...
    public void printStatistics() {
        final String r = "=============  SPAM v0.97a- STATISTICS =============\n Total time ~ " +
                         (endTime - startTime) +
                         " ms\n" +
