...
public class AlgoDim {
    ...
    // of AprioriClose
    private final boolean findClosedPatternsWithCharm;
    // Key: item id     Value:  mdpattern identifier
    private final Map<Integer, String> mapItemIdIdentifier = new HashMap<Integer, String>();
    // Value: item id     key:  mdpattern identifier
    private final Map<String, Integer> mapIdentifierItemId = new HashMap<String, Integer>();
    ...
    private Integer getDimensionForItemId(int value) {
        ...
        return Integer.valueOf(identifier.substring(index + 1));
    }
