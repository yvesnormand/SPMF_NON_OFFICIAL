...
public class AlgoFournierViger08 extends AbstractAlgoPrefixSpan {
    ...
    private final boolean enableBackscanPruning;  // use backscan pruning or not
...
//							removedItems.add(sequence.getItemAtInItemsetAt(index, i));  // AJOUT PHILIPPE 2 OCT
     ...
     * @param removedItemsDestroyed the item occurrences that were removed to do the projection and that resulted in an empty pseudo-projected
     *                              sequence.
     * @return
     */
