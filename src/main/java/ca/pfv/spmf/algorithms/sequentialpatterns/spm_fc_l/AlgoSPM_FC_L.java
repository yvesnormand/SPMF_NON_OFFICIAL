...
public class AlgoSPM_FC_L {
     ...
     * @throws IOException
     */
    public Sequences runAlgorithm(SequenceDatabase database, boolean keepPatterns, boolean verbose, String outputFilePath,
                                  boolean outputSequenceIdentifiers, double alpha1, double beta1, double gramma1)
            throws IOException {
     ...
     * @throws IOException
     */
    protected void runGsp(SequenceDatabase database, CandidateGeneration candidateGenerator, SupportCounting supportCounter, boolean keepPatterns,
                          boolean verbose)
            throws IOException {
