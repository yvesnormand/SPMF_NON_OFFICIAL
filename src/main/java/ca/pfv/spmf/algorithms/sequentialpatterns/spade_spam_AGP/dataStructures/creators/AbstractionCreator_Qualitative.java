...
public class AbstractionCreator_Qualitative extends AbstractionCreator {
     ...
     */
    public void updateIdList(Map<Pattern, EquivalenceClass> totalMap, ItemAbstractionPair pair1, ItemAbstractionPair pair2, int sid, int tid,
    ...
    @Override
    public List<EquivalenceClass> getFrequentSize2Sequences(Map<Integer, Map<Item, List<Integer>>> database,
