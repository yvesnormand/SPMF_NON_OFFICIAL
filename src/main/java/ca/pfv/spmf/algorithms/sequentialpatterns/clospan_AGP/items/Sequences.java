...
public class Sequences {
    ...
    public List<List<Pattern>> levels = new ArrayList<List<Pattern>>();  // itemset classé par taille
    public int nbSequeencesFrequentes = 0;

    public Sequences(String name) {
        this.name = name;
        levels.add(new ArrayList<Pattern>()); // on créé le niveau zéro vide par défaut.
    }
