...
public class SequenceDatabase {
    ...
    private final IdListCreator idListCreator;
            ...
            if (integers[i].codePointAt(0) == '<') {  // Timestamp
                ...
                if (indexParentheseGauche != -1) {
                    ...
                    if (node == null) {
                        ...
                        node = new TrieNode(pairCreator.getItemAbstractionPair(item, abstractionCreator.createDefaultAbstraction()), new Trie(null,
                                idlist));
