...
public class AlgoVMSP {
     ...
     * algorithm
     */
    private final boolean useStrategyForwardExtensionChecking = true;
...
//		System.out.println();
     ...
     */
    private boolean strictlyContainsWithMaxGapHelper(PrefixVMSP pattern1, PrefixVMSP pattern2, int pos1, int pos2,
    ...
    public void printStatistics() {
        final String r = "=============  VMSP v0.97 - STATISTICS =============\n Total time ~ " +
                         (endTime - startTime) +
                         " ms\n" +
