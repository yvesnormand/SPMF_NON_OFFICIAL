...
public class PseudoSequence {
     ...
     */
    private final List<Long> timeShift = new ArrayList<Long>();
    /**
     ...
     */
    private final List<Integer> firstItemset = new ArrayList<Integer>();
    /**
     * List with the first item where each projection starts
     */
    private final List<Integer> firstItem = new ArrayList<Integer>();

    /**
     * //// 鎴戜滑浠庡厛鍓嶇殑鎶曞奖搴忓垪涓緱鍒颁竴涓姇褰卞簭鍒椼é傚洜姝や粠浠庡厛鍓嶆姇褰变腑鍒堕é犳姇褰憋紝鎴戜滑瑕佽é冭檻鍒版姇褰辩殑鍏堝墠鎸囨爣锛燂紵
