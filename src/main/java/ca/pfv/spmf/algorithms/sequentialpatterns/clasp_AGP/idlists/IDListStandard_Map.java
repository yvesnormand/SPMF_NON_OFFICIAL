...
public class IDListStandard_Map implements IDList {
     ...
     */
    private final Map<Integer, List<Position>> sequencePositionsEntries;
    /**
...
//get minimum of sizes of two IDList:
        int size =
                (((IDListStandard_Map) idList).getSequencePositionsEntries().size() > this.getSequencePositionsEntries().size())
                ? this.getSequencePositionsEntries().size()
...
//       Map<Integer, List<Position>> intersection = new HashMap<Integer, List<Position>>(((IDListStandard_Map) idList).getSequencePositionsEntries
//       ().size());
