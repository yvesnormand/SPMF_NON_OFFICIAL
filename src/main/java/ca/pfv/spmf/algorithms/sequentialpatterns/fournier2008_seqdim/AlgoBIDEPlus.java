 ...
 * If you wish to use BIDE+ without SeqDIM, please see the package:é<br/>
...
//					}
    ...
    private Map<ItemSimple, Set<Integer>> findSequencesContainingItems(SequenceDatabase database) {
        ...
        Map<ItemSimple, Set<Integer>> mapSequenceID = new HashMap<ItemSimple, Set<Integer>>(); // pour conserver les ID des séquences: <Id Item,
        // Set d'id de séquences>
    ...
    public void printStatistics(int databaseSize) {
        final String r = "=============  Algorithm - STATISTICS =============\n Total time ~ " +
                         ...
                         '\n' +
                         patterns.toString(databaseSize) +
                         "===================================================\n";
