...
public class AlgoBIDEPlus {
    ...
    private final int[] patternBuffer = new int[BUFFERS_SIZE];
...
//			}
                    ...
                    if (canFullyMatch && eim1WasSeen) {
                        ...
                        for (int k = posItemsetSequenceToMatch; sequence[k] != -1; k++) {
                            ...
                            if (posEim1 != -1 && k > posEim1) {
                                if (!alreadySeenPostfix.contains(item)) {
                            ...
                            if (posEi != -1 && k < posEi) {
                                if (!alreadySeenSuffix.contains(item)) {
    ...
    public void printStatistics() {
        final String r = "============  BIDE+ - SPMF 0.99k - 2016 - STATISTICS =====\n Total time ~ " +
                         (endTime - startTime) +
                         " ms\n" +
                         ...
                         '\n' +
                         " minsup = " + minsuppAbsolute + " sequences." +
                         '\n' +
                         " Pattern count : " +
                         patternCount +
                         '\n' +
