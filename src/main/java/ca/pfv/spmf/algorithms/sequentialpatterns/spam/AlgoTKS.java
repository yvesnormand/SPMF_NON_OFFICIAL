    ...
    private PriorityQueue<PatternTKS> tks(String input, int k) throws IOException {
        ...
        try {
            ...
            while ((thisLine = reader.readLine()) != null) {
                ...
                // kind of metadata
                if (thisLine.isEmpty() || thisLine.startsWith("#") || thisLine.charAt(0) == '%'
                    || thisLine.charAt(0) == '@') {
                    continue;
                }
...
//							System.out.println("PRUNE");
    ...
    public void printStatistics() {
        ...
        final String r = "=============  Algorithm TKS v0.97 - STATISTICS =============\n" +
                         "Minsup after preprocessing : " + minsupAfterPreProcessing + "\n" +
                         "Max candidates: " + maxCandidateCount +
                         " Candidates explored  : " + candidateExplored + "\n" +
                         "Pattern found count : " + kPatterns.size() +
                         '\n' +
                         "Time preprocessing: " + (startMiningTime - startTime) + " ms \n" +
                         "Total time: " + (endTime - startTime) + " ms \n" +
                         "Max memory (mb) : " +
                         MemoryLogger.getInstance().getMaxMemory() +
                         '\n' +
                         "Final minsup value: " + minsup +
                         '\n' +
                         "Intersection count " + Bitmap.INTERSECTION_COUNT + " \n" +
                         "===================================================\n";
