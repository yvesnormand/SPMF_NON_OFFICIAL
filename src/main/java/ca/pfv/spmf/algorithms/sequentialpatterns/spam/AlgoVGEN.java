...
public class AlgoVGEN {
     ...
     */
    private final boolean useImmediateBackwardChecking = true;
    /**
     * activate the backward pruning strategy
     */
    private final boolean useBackwardPruning = false;
...
//		System.out.println();
     ...
     */
    private boolean strictlyContainsWithMaxGapHelper(PrefixVGEN pattern1, PrefixVGEN pattern2, int pos1, int pos2,
                                                     int lastMatchingPositionOfPattern1) {
    ...
    public void printStatistics() {
        final String r = "=============  VGEN v0.97- STATISTICS =============\n Total time ~ " +
                         (endTime - startTime) +
                         " ms\n" +
