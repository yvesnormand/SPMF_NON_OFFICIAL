...
class RecursionCloSpan {
     ...
     */
    private final Map<Integer, Map<Integer, List<Entry<Pattern, Trie>>>> matchingMap;
     ...
     */
    private final Trie generalTrie;
     ...
     */
    public RecursionCloSpan(AbstractionCreator abstractionCreator, Saver saver, long minSupportAbsolute, PseudoSequenceDatabase pseudoDatabase,
                            Map<Item, BitSet> mapSequenceID, boolean findClosedPatterns, boolean executePruningMethods) {
     ...
     */
    private PseudoSequenceDatabase makePseudoProjections(Item item, PseudoSequenceDatabase database, Abstraction_Generic abstraccion,
                                                         boolean firstTime) {
    ...
    private void cloSpanLoop(Pattern prefix, TrieNode prefixNode, int k, PseudoSequenceDatabase context, boolean verbose) {
        ...
        for (Pair pair : pairs) {
            ...
            if (pair.getSupport() >= minSupportAbsolute) {
                ...
                ItemAbstractionPair newPair = ItemAbstractionPairCreator.getInstance().getItemAbstractionPair(pair.getPar().getItem(),
                ...
                if (projection != null) {
                    ...
                    cloSpanLoop(newPrefix, newNodoPrefix, k + 1, projection, verbose); // récursion
                }
            }
        }
    }
