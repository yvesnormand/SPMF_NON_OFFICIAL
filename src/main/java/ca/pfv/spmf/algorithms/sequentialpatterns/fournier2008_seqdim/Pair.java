...
class Pair {
    ...
    public boolean equals(Object object) {
        ...
        // otherwise false
        return (paire.timestamp == this.timestamp) && (paire.postfix == this.postfix)
    ...
    public int hashCode() {// Ex: 127333,P,X,1  127333,N,Z,2
        ...
        final String r = String.valueOf(timestamp) +
                         (postfix ? 'P' : 'N') + // the letters here have no meanings. they are just used for the hashcode
