...
public class AlgoSeqDim {
    ...
    private void writeToFile(MDSequence mdsequence) throws IOException {
        ...
        // append mdpattern
        final String buffer = mdsequence.getMdpattern().toStringShort() +
                              // append mdsequence
                              mdsequence.getSequence().toStringShort() +
                              // append support
                              " #SUP: " +
                              mdsequence.getAbsoluteSupport();
        // write to file
        writer.write(buffer);
        writer.newLine();
    }
    ...
    public void printStatistics(int databaseSize) {
        final String r = "=============  SEQ-DIM - STATISTICS =============\n Total time ~ " +
                         (endTime - startTime) +
                         " ms\n" +
                         " max memory : " +
