...
class CandidateGeneration {
     ...
     */
    public List<Pattern> generateCandidates(Set<Pattern> frequentSet, AbstractionCreator abstractionCreator, Map<Item, Set<Pattern>> indexationMap,
                                            int k, double minSupportAbsolute) {
            ...
            for (Pattern frequentPattern1 : frequentList) {
                ...
                if (matching != null) {
                    ...
                    for (Pattern frequentPattern2 : matching) {
                        ...
                        Pattern candidate = abstractionCreator.generateCandidates(abstractionCreator, frequentPattern1, frequentPattern2,
                                minSupportAbsolute);
