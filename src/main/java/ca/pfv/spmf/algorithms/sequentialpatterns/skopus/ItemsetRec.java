...
public class ItemsetRec extends ArrayList<Integer> {
    ...
    public int count; // éééééééé		(éééééééڼééésupport)
    public double value; // ééȤéȶéééֵ
    public boolean self_sufficient; // filter itemsetséééééУéééééϡéééééé㡱éééééıéé?
    ...
    //ʹéééirééָééλéõéԪéسéʼééһéééµééééééééééʼλéõéԪéé
    ...
    /**
     * //éééééééééééééééĿééһéééééééétrue
     */
    ...
    public boolean equals(Object o) {
        if (!(o instanceof final ItemsetRec list)) {
            return false;
        }
