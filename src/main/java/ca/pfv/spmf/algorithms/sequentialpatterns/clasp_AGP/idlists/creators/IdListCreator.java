...
public interface IdListCreator {
    ...
    void initializeMaps(Map<Item, TrieNode> frequentItems, Map<Item, Map<Integer, List<Integer>>> projectingDistanceMap, Map<Integer,
            Integer> sequenceSize, Map<Integer, List<Integer>> itemsetSequenceSize);
