...
public class AlgoPrefixSpan_with_Strings {
    ...
    private Map<String, Set<Integer>> findSequencesContainingItems(SequenceDatabase contexte) {
        ...
        Map<String, Set<Integer>> mapSequenceID = new HashMap<String, Set<Integer>>(); // pour conserver les ID des séquences: <Id Item, Set d'id
        // de séquences>
...
//					}
    ...
    public void printStatistics(int size) {
        final String r = "=============  PREFIXSPAN - STATISTICS =============\n Total time ~ " +
                         (endTime - startTime) +
                         " ms\n" +
