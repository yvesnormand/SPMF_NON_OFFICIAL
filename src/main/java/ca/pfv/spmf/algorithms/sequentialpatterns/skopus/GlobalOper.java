...
public class GlobalOper {
    private static final ArrayList<Double> lf = new ArrayList<Double>();
    ...
    public static void appendFileContent(String fileName, String content) {
        try {
            //ééһééдéļéééééééé캯éééеĵڶééééééétrueééʾéé׷ééééʽдéļé  
