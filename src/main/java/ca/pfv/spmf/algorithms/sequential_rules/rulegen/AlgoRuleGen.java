 ...
 * <br/><br/>
 * <p>
 * M. J. Zaki, éSPADE: An Efficient Algorithm for Mining Frequent Se-quences,éMachine Learning, vol. 42, no.1-2, pp. 31-60, 2001.
 * <br/><br/>
 * <p>
...
public class AlgoRuleGen {
    ...
    private void tryToGenerateRule(SequentialPattern pattern1, SequentialPattern pattern2, double minconf) throws IOException {
        ...
        final String buffer = pattern1.itemsetsToString() +
                              " ==> " +
                              pattern2.itemsetsToString() +
//
                              // write support
                              " #SUP: " +
                              pattern2.getAbsoluteSupport() +

                              // write confidence
                              " #CONF: " +
                              conf;

        writer.write(buffer);  // write to file
