...
public class AlgoHUSRM {
     ...
     */
    private final boolean deactivateStrategy1 = false;
    /**
     * Strategy 2: remove rules contains two items a--> b with a sequence estimated utility < minutil
     */
    private final boolean deactivateStrategy2 = false;
     ...
     * /*  rule antecedent
     */
    private final boolean deactivateStrategy3 = false;
    /**
     ...
     */
    private final boolean deactivateStrategy4 = false;
    /**
    ...
    public void runAlgorithm(String input, String output,
        ...
        Map<Integer, Map<Integer, EstimatedUtilityAndSequences>> mapItemItemEstimatedUtility = new HashMap<Integer, Map<Integer,
                EstimatedUtilityAndSequences>>();
        ...
        for (Entry<Integer, Map<Integer, EstimatedUtilityAndSequences>> mapI : mapItemItemEstimatedUtility.entrySet()) {
            ...
            while (iterEntry.hasNext()) {
                ...
                Map.Entry<java.lang.Integer, EstimatedUtilityAndSequences> entry =
                        iterEntry
                                .next();
        ...
        for (Entry<Integer, Map<Integer, EstimatedUtilityAndSequences>> entryX : mapItemItemEstimatedUtility.entrySet()) {
            ...
            for (Entry<Integer, EstimatedUtilityAndSequences> entryYUtility : entryX.getValue().entrySet()) {
                ...
                // We create the utility table of rule X -é> Y
