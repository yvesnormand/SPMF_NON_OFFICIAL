 ...
 * <p>
 * Original paper:
 * Jian Pei, Jiawei Han, Behzad Mortazavi-Asl, Jianyong Wang, Helen Pinto, Qiming Chen, Umeshwar Dayal, Meichun Hsu: Mining Sequential Patterns by
 * Pattern-Growth: The PrefixSpan Approach. IEEE Trans. Knowl. Data Eng. 16(11): 1424-1440 (2004)
 */
...
//		Map<Object, Object> candidates = frequencies.entrySet().stream().filter(e -> e.getValue() > 2).collect(Collectors.toMap(p -> ((Entry<Item,
//		Integer>) p).getKey(), p -> ((Entry<Item, Integer>) p).getValue()));
...
//		System.out.println(frequencies);
    ...
    public class Projection {
        ...
        private final Map<Integer, Bitvector> II; //Inverted Index
