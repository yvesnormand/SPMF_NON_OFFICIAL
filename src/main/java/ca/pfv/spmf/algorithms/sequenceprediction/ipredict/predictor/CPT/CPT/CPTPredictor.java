...
public class CPTPredictor extends Predictor {
    ...
    public Sequence Predict(Sequence target) {
        ...
        int maxRecursion = (parameters.paramInt("recursiveDividerMax") > targetArray.length)
                           ? targetArray.length
     ...
     */
    public void RecursiveDivider(Item[] targetArray, int minSize, Map<Integer, Float> countTable, HashSet<Integer> hashSidVisited,
                                 int initialTargetArraySize) {
