...
public class CalculateDatabaseInfo {
    ...
    private final Set<Integer> allItem = new HashSet<Integer>();
    ...
    public void OutputResult(String outputPath) {
        ...
        System.out.println("Number of transations : " + databaseSize);
        System.out.println("Total utility : " + totalUtility);
        System.out.println("Number of distinct items : " + allItem.size());
        System.out.println("Maximum Id of item : " + maxID);
        System.out.println("Average length of transaction : " + avgLength);
        System.out.println("Maximum length of transaction : " + maxLength);

        output.println("----------Database Information----------");
        output.println("Input file path : " + inputPath);
        output.println("Output file path : " + outputPath);
        output.println("Number of transations : " + databaseSize);
        output.println("Total utility : " + totalUtility);
        output.println("Number of distinct items : " + allItem.size());
        output.println("Maximum Id of item : " + maxID);
        output.println("Average length of transaction : " + avgLength);
        output.println("Maximum length of transaction : " + maxLength);
