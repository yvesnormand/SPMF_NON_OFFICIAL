...
public class EnlargeGraph {
     ...
     */
    private static final int TOTAL_NUM_ATTR = ParametersSettingAERMiner.TOTAL_NUM_ATTR;
    /**
     * store path of file that record attributes of vertices each time
     */
    private static final String ATTR_FILE_PATH = ParametersSettingAERMiner.ATTR_FILE_PATH;
    /**
     * store path of file that record edges of vertices each time
     */
    private static final String EDGE_FILE_PATH = ParametersSettingAERMiner.EDGE_FILE_PATH;
    private static final String VERTICES_FILE_PATH = ParametersSettingAERMiner.VERTEX_MAP_NAME_PATH;
    private static final int VERTEXNUM = ParametersSettingAERMiner.VERTEXNUM;

    private static final int MOVENUM = 10000;
