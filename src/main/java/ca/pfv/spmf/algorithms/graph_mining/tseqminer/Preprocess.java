...
public class Preprocess {
     ...
     */
    private static final String ATTRI_MAPPING_PATH = ParametersSetting.ATTRI_MAPPING_PATH;
    /**
     * this flag indicate how to do discretization
     */
    private static final int DISCRET_FLAG = ParametersSetting.DISCRE_FLAG;
    private static final int PASS_FLAG = -999;
    private static final String EVENTTYPE_MAPPING_PATH = ParametersSetting.EVENTTYPE_MAPPING_PATH;
    /**
    ...
    private static int findTrendFlag(int discretFlag, int vId, int attrType, double val1, double val2) {
        ...
        switch (discretFlag) {
            ...
            case 1: {
                ...
                if (diff > 2 * scale * stdDev) {
                    trendFlag = 4;
                } else if (diff > scale * stdDev) {
                    trendFlag = 3;
                } else if (diff < -2 * scale * stdDev) {
                    trendFlag = 0;
                } else if (diff < scale * stdDev) {
                    trendFlag = 1;
                } else {
