...
public class ReadGraph {
     ...
     */
    private static final int TOTAL_NUM_ATTR = ParametersSetting.TOTAL_NUM_ATTR;
    /**
     * store path of file that record attributes of vertices each time
     */
    private static final String ATTR_FILE_PATH = ParametersSetting.ATTR_FILE_PATH;
    /**
     * store path of file that record edges of vertices each time
     */
    private static final String EDGE_FILE_PATH = ParametersSetting.EDGE_FILE_PATH;
