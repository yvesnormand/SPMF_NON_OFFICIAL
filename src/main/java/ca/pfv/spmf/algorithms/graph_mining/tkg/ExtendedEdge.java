...
public class ExtendedEdge implements Serializable {
    ...
    public boolean equals(Object another) {
        ...
        if (!(another instanceof final ExtendedEdge that)) {
            return false;
        }
        return this.v1 == that.getV1() && this.v2 == that.getV2() && this.vLabel1 == that.getvLabel1()
    ...
    public String toString() {
        final String sb = "<" + v1 + "," + v2 + "," + vLabel1 + "," + vLabel2 +
                          "," + edgeLabel + ">";
        return sb;
    }
