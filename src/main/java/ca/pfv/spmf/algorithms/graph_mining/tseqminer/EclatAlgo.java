...
public class EclatAlgo {
    ...
    private static final String FRE_ITEMSET_PATH = ParametersSetting.FRE_ITEMSET_PATH;
...
//        }
    ...
    private static void processProjectedPart(List<Integer> prefix, List<Integer> projectedFreItems, List<STPSet> projectedSupPoints, Map<Itemset,
            STPSet> itemsetSTPSetMap)
            throws IOException {
