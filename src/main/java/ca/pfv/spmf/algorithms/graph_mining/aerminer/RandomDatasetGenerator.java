...
public class RandomDatasetGenerator {
    private static final String rootPath = ParametersSettingAERMiner.projectPath + "/dataset/synthetic/";
    private static final String attrMapFileName = "/attrMap.txt";
    private static final String edgesFileName = "/edges.txt";
    private static final String attributesFileName = "/attributes.txt";
    ...
    private static void generateDirectoryAndFiles() throws IOException {
        String dirName = "t" + noTimestamps + "_v" + noVertex + "_e" + noEdges +
                         "_a" + noAttribute;
