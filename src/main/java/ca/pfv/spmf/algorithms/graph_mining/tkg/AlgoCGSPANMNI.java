 ...
 * For MNI definition please check Bringmann, B, Nijssen, S. What is frequent in a single graph?. In: Proc. 12th PacificAsia Conference on
 * Knowledge Discovery and Data Mining, Osaka, Japan, May 20-23, 2008:858–863. <br/>
...
public class AlgoCGSPANMNI extends AlgoCGSPANAbstract {
     ...
     */
    protected void cgSpanDFS(DFSCode c, List<DatabaseGraph> graphDB, Set<Integer> graphIds, ProjectedCompact projected,
     ...
     */
    protected void outputClosedOneVertex(List<DatabaseGraph> graphDB, ProjectedCompact projected)
            throws IOException, ClassNotFoundException, InterruptedException {
        // Create a map (key = vertex label, value = graph ids)
        // to count the support of each vertex
        Map<Integer, Set<Integer>> labelM = new HashMap<>();
