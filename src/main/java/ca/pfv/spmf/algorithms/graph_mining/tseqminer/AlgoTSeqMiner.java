...
//    private static Itemset startItemset;
     ...
     */
    private final boolean INTERPRET_RESULT = true;
    /**
...
//        System.out.println("sequence miner input: timestamps-" + timestampMapItemAG.keySet().size() + "   vertex-" + timestampMapItemAG.get(0)
//        .getTotalSize());
