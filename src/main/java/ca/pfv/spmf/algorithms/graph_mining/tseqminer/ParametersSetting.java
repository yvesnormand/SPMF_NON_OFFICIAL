...
granularity? " + LARGE_GRAINED_PRUNING
...
//        System.out.println("allow pruning? " + ADOPTING_PRUNING + "  large granularity? " + LARGE_GRAINED_PRUNING + "  mini granularity? " +
MINI_GRAINED_PRUNING);
//        System.out.println((time2 - time1)/ 1000);
