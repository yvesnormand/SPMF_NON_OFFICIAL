...
public class MainTestHUESpan {
    public static void main(String[] args) throws IOException {
        ...
        algo.runAlgorithm(inputFile, outputFile, minUtilityRatio, maxDuration, checkMaximumUtility, useTighterUpperBound, outputSingleEvents,
                useCoocMatrix, pruningPrefix);
        algo.printStats();
    }
