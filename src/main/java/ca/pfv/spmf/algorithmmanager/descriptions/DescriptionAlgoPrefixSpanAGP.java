...
/**
 * This class describes the PrefixSpan algorithm parameters (version implemented by Antonio G.P.). It is designed to be used by the graphical and
...
public class DescriptionAlgoPrefixSpanAGP extends DescriptionOfAlgorithm {
    ...
    public void runAlgorithm(String[] parameters, String inputFile, String outputFile) throws IOException {
        ca.pfv.spmf.algorithms.sequentialpatterns.prefixSpan_AGP.items.creators.AbstractionCreator abstractionCreator =
                ca.pfv.spmf.algorithms.sequentialpatterns.prefixSpan_AGP.items.creators.AbstractionCreator_Qualitative
                        .getInstance();
         ...
         */
        ca.pfv.spmf.algorithms.sequentialpatterns.prefixSpan_AGP.items.SequenceDatabase sd =
                new ca.pfv.spmf.algorithms.sequentialpatterns.prefixSpan_AGP.items.SequenceDatabase(
                        abstractionCreator);
