...
public class DescriptionAlgoGSP extends DescriptionOfAlgorithm {
    ...
    public void runAlgorithm(String[] parameters, String inputFile, String outputFile) throws IOException {
         ...
         */
        ca.pfv.spmf.algorithms.sequentialpatterns.gsp_AGP.items.SequenceDatabase sd =
                new ca.pfv.spmf.algorithms.sequentialpatterns.gsp_AGP.items.SequenceDatabase(
                        abstractionCreator);
