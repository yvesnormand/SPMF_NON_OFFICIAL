...
public class DescriptionAlgoCloSpan extends DescriptionOfAlgorithm {
    ...
    public void runAlgorithm(String[] parameters, String inputFile, String outputFile) throws IOException {
        ca.pfv.spmf.algorithms.sequentialpatterns.clospan_AGP.items.creators.AbstractionCreator abstractionCreator =
                ca.pfv.spmf.algorithms.sequentialpatterns.clospan_AGP.items.creators.AbstractionCreator_Qualitative
                        .getInstance();
        ...
        ca.pfv.spmf.algorithms.sequentialpatterns.clospan_AGP.items.SequenceDatabase sd =
                new ca.pfv.spmf.algorithms.sequentialpatterns.clospan_AGP.items.SequenceDatabase();
