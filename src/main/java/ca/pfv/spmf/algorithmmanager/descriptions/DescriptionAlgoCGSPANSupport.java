...
/**
 * This class describes the CGSPAN algorithm parameters when support threshold is used. It is designed to be used by the graphical and command line
 * interface.
 *
...
public class DescriptionAlgoCGSPANSupport extends DescriptionOfAlgorithm {
    ...
    public void runAlgorithm(String[] parameters, String inputFile, String outputFile)
        ...
        if (parameters.length >= 7 && !"".equals(parameters[6])) {
