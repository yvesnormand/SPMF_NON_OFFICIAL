...
public class ExperimenterScalabilityWindow extends JFrame implements ThreadCompleteListener, UncaughtExceptionHandler {
     ...
     */
    private final JTextField textFieldParameters;
    /**
     * text field to specify the timeount
     */
    private final JTextField textFieldTimeLimit;
    /**
     * text field to specify the values for the varied parameter
     */
    private final JTextField textFieldValues;
    /**
     * text field to provide a list of algorithms
     */
    private final JTextField textFieldAlgorithms;
    /**
     ...
     */
    private final JTextField textFieldOutputDirectory;
    /**
     * The text field to provide a path to a jar file
     */
    private final JTextField textFieldJARPath;
    /**
     * Combo box for the list of algorithms
     */
    private final JComboBox comboBoxAlgorithms;
    /**
    ...
    public ExperimenterScalabilityWindow() {
        ...
        buttonHelp.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                try {
                    java.awt.Desktop.getDesktop().browse(java.net.URI.create("https://www.philippe-fournier-viger" +
                                                                             ".com/spmf/ExperimenterPerformance_Scalability.php"));
    ...
    protected void addAnAlgorithm() throws Exception {
        ...
        if (algorithms == null || "".equals(algorithms)) {
            ...
            if (!sameMandatoryParameters) {
                JOptionPane.showMessageDialog(null,
                        "This algorithm (" + newAlgorithm + ") does not have the same mandatory parameters has other algorithms in this list (e.g. "
                        + algorithmNames[0] + "). Hence, it cannot be added.", "Error",
                        JOptionPane.ERROR_MESSAGE);
            }
...
//			String variedParameterName = AlgorithmManager.getInstance().getDescriptionOfAlgorithm(algorithmNames[0]).getParametersDescription()
//			[positionParameter].name;
//
            ...
            JOptionPane.showMessageDialog(null,
                    "An error occured while trying to run the experiment. ERROR MESSAGE = " + e, "Error",
                    JOptionPane.ERROR_MESSAGE);
    ...
    protected void askUserToChooseSPMFJarPath() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null,
                    "An error occured while opening the SPMF.jar file path dialog. ERROR MESSAGE = " + e,
...
//				System.out.println(outputDirectory);
    ...
    protected void updateUserInterfaceAfterAlgorithmSelection(String algorithmName, boolean isSelected) throws Exception {
        ...
        if (isSelected) {
            ...
            buttonAddAlgorithm.setEnabled(algorithm != null);
