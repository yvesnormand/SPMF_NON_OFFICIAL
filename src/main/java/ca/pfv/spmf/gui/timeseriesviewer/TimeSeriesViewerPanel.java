...
public class TimeSeriesViewerPanel extends JPanel {
     ...
     **/
    private final List<TimeSeries> multipleTimeSeries;
    /**
     * The color of each time series
     **/
    private final Color[] multipleTimeSeriesColors;
    /**
     ...
     */
    Color[] colors = new Color[] { Color.blue, Color.green, Color.red, Color.yellow, Color.magenta, Color.orange, Color.cyan, Color.pink,
