...
public class FilterSelectionWindow extends JDialog {
     ...
     */
    private final JComboBox comboBoxFilters;
    /**
     * the combo box for letting the user choose a column
     */
    private final JComboBox comboBoxColumns;
    /**
     * the pattern vizualizer window that has created that filter section window
     */
    private final PatternVizualizer patternVisualizer;
    /**
    ...
    public FilterSelectionWindow(Vector<String> columnNames,
        ...
        DocumentListener documentListener = new DocumentListener() {
            ...
            private void printIt(DocumentEvent documentEvent) {
                ...
                btnAddFilter.setEnabled(!textField.getText().isEmpty());
            }
        };
    ...
    private void addFilter() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null,
                    "Invalid value in text field. ERROR MESSAGE = " + e, "Error",
